...
public class MenuScript : MonoBehaviour
{
    ...
    [Tooltip("Nome da cena que deve ser carregada ao precionar o bot�o 1")]
    [SerializeField] private string cenaBotao1;
    [Tooltip("Nome da cena que deve ser carregada ao precionar o bot�o 2")]
    [SerializeField] private string cenaBotao2;
    [Tooltip("Nome da cena que deve ser carregada ao precionar o bot�o 3")]
    [SerializeField] private string cenaBotao3;
    [Tooltip("Nome da cena que deve ser carregada ao precionar o bot�o 4")]
    [SerializeField] private string cenaBotao4;
    [Tooltip("Nome da cena que deve ser carregada ao precionar o bot�o 5")]
    [SerializeField] private string cenaBotao5;
    [Tooltip("Nome da cena que deve ser carregada ao precionar o bot�o 5")]
    [SerializeField] private string cenaBotao51;
    [Tooltip("Nome da cena que deve ser carregada ao precionar o bot�o 6")]
